<template>
  <tr v-bind:class="'pair-row' + (isActive ? '' : ' opacity-50')">
    <td class="pair-meta">
      <div class="d-flex flex-row align-items-center">
        <img
          ...
          loading="lazy"
        /><span class="pair-meta-symbol fw-bold">{{ info.symbol }}</span
    ...
    <td v-bind:class="'pair-daily-change text-end color-' + ticker.direction">
      ...
      <template v-else>
        <span v-if="ticker.direction === 'down'">
          <BIconArrowDownShort /></span>
    ...
    <td class="text-end">
      <div class="d-grid d-flex justify-content-end">
        <router-link
          ...
          v-bind:class="
            'btn btn-light btn-sm col-lg-6' + (isActive ? '' : ' disabled')
          "
          role="button"
